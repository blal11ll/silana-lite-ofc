export async function all(m) {
  ...
  if ((m.mtype === 'groupInviteMessage' || m.text.startsWith('https://chat') || m.text.startsWith('open this link')) && !m.isBaileys && !m.isGroup) {
    ...
    this.sendMessage(m.chat, {
      text: `+لقد استلمت رابط المجموعة. يرجى الانتظار حتى يقوم المطور بإعطاء البوت الصلاحية للانضمام. إذا كنت بحاجة إلى مساعدة، للتواصل مع المطور رقم مطوري (967781974099+).`.trim()
    }, { quoted: m });
